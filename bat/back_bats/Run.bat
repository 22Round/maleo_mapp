...
set APP_XML_DESKTOP=application.xml

::set SCREEN_SIZE=NexusOne
::set SCREEN_SIZE=iPhoneRetina
::set SCREEN_SIZE=450x762:450x800
set SCREEN_SIZE=640x960:640x960
::set SCREEN_SIZE=320x480:320x480
::set SCREEN_SIZE=408x544:408x544
::set SCREEN_SIZE=500x500:500x500
::set SCREEN_SIZE=600x1000:600x1000
...
echo.
start /MIN adl -screensize %SCREEN_SIZE% "%APP_XML_DESKTOP%" "%APP_DIR%"
