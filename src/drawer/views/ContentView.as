package drawer.views {
	...
	public class ContentView extends ScrollContainer {
		...
		override protected function initialize():void {
			...
			this._openModePicker.dataProvider = new ListCollection([{label: "Below", data: RelativeDepth.BELOW}, {label: "Above", data: RelativeDepth.ABOVE},]);
			this._openModePicker.addEventListener(Event.CHANGE, openModePicker_changeHandler);
			
			var optionsList:List = new List();
			optionsList.dataProvider = new ListCollection([{label: "Open Mode", accessory: this._openModePicker},]);
