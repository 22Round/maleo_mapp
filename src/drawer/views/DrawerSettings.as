package drawer.views {
	...
	import drawer.views.DrawerSettingsData;
	...
	public class DrawerSettings extends PanelScreen {
		...
		override protected function initialize():void {
			...
			this._iconTypePicker.typicalItem = DrawerSettingsData.ICON_ACCESSORY_TYPE_DISPLAY_OBJECT;
			this._iconTypePicker.dataProvider = new ListCollection(new <String>[DrawerSettingsData.ICON_ACCESSORY_TYPE_DISPLAY_OBJECT, DrawerSettingsData.ICON_ACCESSORY_TYPE_TEXTURE, DrawerSettingsData.ICON_ACCESSORY_TYPE_LABEL,]);
			this._iconTypePicker.listProperties.typicalItem = DrawerSettingsData.ICON_ACCESSORY_TYPE_DISPLAY_OBJECT;
			...
			this._iconPositionPicker.dataProvider = new ListCollection(new <String>[RelativePosition.TOP, RelativePosition.RIGHT, RelativePosition.BOTTOM, RelativePosition.LEFT, RelativePosition.LEFT_BASELINE, RelativePosition.RIGHT_BASELINE,
			...
			this._gapPicker.dataProvider = new ListCollection([{label: GAP_LABEL_INFINITE, value: true}, {label: GAP_LABEL_DEFAULT, value: false},]);
			...
			this._accessoryTypePicker.typicalItem = DrawerSettingsData.ICON_ACCESSORY_TYPE_DISPLAY_OBJECT;
			this._accessoryTypePicker.dataProvider = new ListCollection(new <String>[DrawerSettingsData.ICON_ACCESSORY_TYPE_DISPLAY_OBJECT, DrawerSettingsData.ICON_ACCESSORY_TYPE_TEXTURE, DrawerSettingsData.ICON_ACCESSORY_TYPE_LABEL,]);
			this._accessoryTypePicker.listProperties.typicalItem = DrawerSettingsData.ICON_ACCESSORY_TYPE_DISPLAY_OBJECT;
			...
			this._accessoryPositionPicker.dataProvider = new ListCollection(new <String>[RelativePosition.TOP, RelativePosition.RIGHT, RelativePosition.BOTTOM, RelativePosition.LEFT,
			//RelativePosition.MANUAL,
			]);
			...
			this._accessoryGapPicker.dataProvider = new ListCollection([{label: GAP_LABEL_INFINITE, value: true}, {label: GAP_LABEL_DEFAULT, value: false},]);
			...
			this._layoutOrderPicker.dataProvider = new ListCollection(new <String>[ItemRendererLayoutOrder.LABEL_ICON_ACCESSORY, ItemRendererLayoutOrder.LABEL_ACCESSORY_ICON,]);
			...
			this._horizontalAlignPicker.dataProvider = new ListCollection(new <String>[HorizontalAlign.LEFT, HorizontalAlign.CENTER, HorizontalAlign.RIGHT,]);
			...
			this._verticalAlignPicker.dataProvider = new ListCollection(new <String>[VerticalAlign.TOP, VerticalAlign.MIDDLE, VerticalAlign.BOTTOM,]);
		...
		private function customHeaderFactory():Header {
			...
			header.rightItems = new <DisplayObject>[doneButton];
			return header;
		}
